import { BufferBase } from "kansei";
import { ComputeBuffer } from "kansei";
import { Vector4 } from "kansei";
import { InstancedGeometry } from "kansei";
import { PlaneGeometry } from "./PlaneGeometry";
import { FontInfo } from "kansei/dist/sdf/text/FontLoader";

class TextGeometryCustom extends InstancedGeometry {
    ...
    constructor(options: {
        ...
        super(new PlaneGeometry(1, 1, 20, 20), options.text.length);
        ...
        this._color = options.color || new Vector4(1, 1, 100, 100);
